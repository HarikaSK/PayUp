    ...
    return (
        <ScrollView>
            <View style={styles.containerBox}>
                ...
                <TextInput placeholder="Enter Split Amount" keyboardType = "numeric" autoCapitalize="none" autoCorrect={false} onChangeText={(e) => {setAmount(e);}} value={amount} style={styles.theBetterSearchBar}></TextInput>
